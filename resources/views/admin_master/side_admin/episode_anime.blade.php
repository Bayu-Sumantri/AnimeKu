    ...
    <form action="{{ route('episode_update', $animeku->id) }}" method="post" enctype="multipart/form-data">
        ...
        <div class="bg-secondary rounded h-100 p-4">
            ...
            <div class="form-floating mb-3">
                <input type="text" name="vidio_url" class="form-control" id="floatingInput" placeholder="AnimeKu">
                <label for="floatingInput">Vidio Link</label>
            </div>

            <div class="form-floating mb-3">
                <input type="number" name="episode_number" class="form-control" id="floatingInput"
                    placeholder="AnimeKu">
