                            ...
                            <ul>
                                ...
                                <li><a href="{{ url("/category") }}">Categories <span class="arrow_carrot-down"></span></a>
                                    <ul class="dropdown">
                                        ...
                                        <li class="{{ request()->routeIs('anim') ? 'active' : '' }}"><a  href="{{ url("/anim_blog") }}">Blog Details</a></li>
                                        <li><a href="{{ route("register") }}">Sign Up</a></li>
                                        <li><a href="{{ route("login") }}">Login</a></li>
                                    </ul>
                                </li>
                                <li><a class="{{ request()->routeIs('anim_blog') ? 'active' : '' }}" href="{{ url("/anim_blog") }}">Our Blog</a></li>
