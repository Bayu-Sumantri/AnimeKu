            ...
            <div class="row">
                    ...
                    <div class="login__form">
                        ...
                        <form action="{{ route('register') }}" method="POST">
                            ...
                            <div class="input__item">
                                ...
                                <input type="text" placeholder="Your Name" name="name" :value="old('name')" autofocus autocomplete="name" required>
                            ...
                            <div class="input__item">
                                ...
                                <input type="email" placeholder="Email address" name="email" :value="old('email')" required autocomplete="username" required>
                            ...
                            <div class="input__item">
                                ...
                                <input type="password" placeholder="Password" name="password_confirmation" required autocomplete="new-password" required>
                ...
                <div class="col-lg-6">
                    <div class="login__social__links">
                        <h3>Login With:</h3>
                        <ul>
                            <li><a href="{{ url("#") }}" class="facebook"><i class="fa fa-facebook"></i> Sign in With Facebook</a>
                            </li>
                            <li><a href="{{ url("#") }}" class="google"><i class="fa fa-google"></i> Sign in With Google</a></li>
                            <li><a href="{{ url("#") }}" class="twitter"><i class="fa fa-twitter"></i> Sign in With Twitter</a></li>
                        </ul>
                    </div>
                </div>
            </div>
